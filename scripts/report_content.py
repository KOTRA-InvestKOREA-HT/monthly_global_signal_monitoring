...
TEXTS = {
    ...
    "en": {
        ...
        "business_near_miss_note": "Product link unconfirmed · key business activity",
        ...
        "item_target_label": "Target product/tech",
        "item_trend_label": "{month} global business trend",
        "item_note": "Companies without a five-signal profile this month, but where a global business trend directly linked to a target product/tech was detected in {month}. For companies exempt from the technology-link check, key business activity is shown and the card says so. Monitored for potential signal development.",
